# Call for Participation (CfP) to host PyCon APAC 2023
...
- [Additional items for PyCon APAC 2023](#addons)

This is the announcement for the Call for Participation (CfP) for PyCon Asia Pacific
(APAC) 2023. The purpose of this call is to select an Asia Pacific in-country team
...
PyCon Asia Pacific in 2023 in a location they are local to. PyCon APAC is
...
8. Proposed dates for PyCon APAC 2023.
...
## Additional considerations for PyCon APAC 2023<a name="addons"></a>

Below are additional considerations specific for 2023 and is to be
